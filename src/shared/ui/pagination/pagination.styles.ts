...
export const paginationClassNames = {
  ...
  link: "inline-flex h-9 min-w-9 items-center justify-center rounded-full border border-border px-3 text-sm no-underline transition-colors hover:border-accent-vivid hover:text-accent focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-vivid/60",
